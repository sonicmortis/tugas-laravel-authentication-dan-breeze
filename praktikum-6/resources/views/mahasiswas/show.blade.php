    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-item">
                ...
                <span class="value">{{ $mahasiswa->jurusan }}</span>
            </div>
            <div class="card-item">
            ...
            <div class="card-item">
                ...
                <span class="value">{{ $mahasiswa->created_at->format('d/m/Y H:i') }}</span>
            </div>
            <div class="card-item">
                <span class="label">Diupdate:</span>
                <span class="value">{{ $mahasiswa->updated_at->format('d/m/Y H:i') }}</span>
            </div>
        </div>
